...
function get_footer_custom_script(){
  ...
  <script>
    ...
    function show_pre(data){
        let uid = jQuery(data).parent().parent().attr("id");
        let active_step = parseInt(jQuery(data).parent().parent().attr("data-step"));
        if(active_step!=1){
            active_step-=1;
            jQuery("div#"+uid+" .msf-step-input.active").removeClass("active");
            jQuery("div#"+uid+" #step_"+uid+"_"+active_step+"").addClass("active");
            jQuery(data).parent().parent().attr("data-step",active_step);
        }

        if(active_step==1){
            jQuery("div#"+uid+" .step.pre,div#"+uid+" .submit_form").removeClass("current");
            jQuery("div#"+uid+" .step.next").addClass("current");
        }
        
        if(active_step==2){
            jQuery("div#"+uid+" .submit_form").removeClass("current");
            jQuery("div#"+uid+" .step.pre,div#"+uid+" .step.next").addClass("current");
        }
        
        if(active_step==3){
            jQuery("div#"+uid+" .submit_form").addClass("current");
            jQuery("div#"+uid+" .step.pre").addClass("current");
            jQuery("div#"+uid+" .step.next").removeClass("current");
        }
    }
    ...
    function show_next(data){
        ...
        //console.log(uid);
        let active_step = parseInt(jQuery(data).parent().parent().attr("data-step"));
        jQuery("div#"+uid+" .message_area").html("");
        if(active_step!=3){
            // validation
            let progress = true;
            jQuery("div#"+uid+" .msf-step-input.active .data-input-element").each(function(){
    ...
    function msf_submit(data){
        ...
        if(active_step==3){
            ...
            jQuery("div#"+uid+" .data-input-element").each(function(){
                let required = jQuery(this).attr("required");
...
function multi_step_fun(){
    ...
    <div class="full-width">
        <div class="msf-container">
            ...
            <div class="msf-wrap" id="<?=$uid?>" data-step="1">
                ...
                <div class="msf-single-step">
                    ...
                    <div class="step1 msf-step-input active" id="step_<?=$uid?>_1">
                        <input type="hidden" id="custId" name="formid" value="1" class="data-input-element">
                    ...
                    <div class="msf-step-input" id="step_<?=$uid?>_2">
                    ...
                    <div class="msf-step-input name-email" id="step_<?=$uid?>_3">
                        <div class="msf-step-input-field">
                ...
                <div class="msf-single-step msf-buttons">
                    <button type="button" class="step pre target-btn" onclick="show_pre(this)">Previous</button>
                    <button type="button" class="step next current target-btn" onclick="show_next(this)">Next</button>
                    <button type="button" class="target-btn submit_form" id="submit_form" onclick="msf_submit(this)">Submit</button>
                </div>
...
function multi_step_claim_fun(){
    ...
    <div class="full-width">
        <div class="msf-container">
			<div class="msf-wrap" id="<?=$form_id?>" data-step="1">
                ...
                <div class="msf-single-step">
                    ...
                    <div class="step1 msf-step-input active" id="step_<?=$form_id?>_1">
                        <input type="hidden" id="custId" name="formid" value="2" class="data-input-element">
                        <input type="hidden" name="action" value="w1d_msf_process" class="data-input-element">
                        <div class="msf-step-input-field flex-column">
                            <input type="text" name="Serial" id="serial" required="required" class="data-input-element">
                            <label for="serial">Serial # *</label>
                    ...
                    <div class="msf-step-input" id="step_<?=$form_id?>_2">
                      <div>
                        <div class="msf-step-input-checkbox">
                            ...
                            <div class="pare pare-1">
                                <div class="c-option">
                                  <input type="checkbox" name="Reason for Claim[]" value="Item displays an error message" id="c-1" class="data-input-element">
                                  <label for="c-1">Item displays an error message</label>
                                </div>
                                <div class="c-option">
                                  <input type="checkbox" name="Reason for Claim[]" value="Item has a broken component from normal use" id="c-2" class="data-input-element">
                                  <label for="c-2">Item has a broken component from normal use</label>
                                </div>
                              </div>
                              <div class="pare pare-2">
                                  <div class="c-option">
                                    <input type="checkbox" name="Reason for Claim[]" value="Item is deviating from set factory specifications" id="c-3" class="data-input-element">
                                    <label for="c-3">Item is deviating from set factory specifications</label>
                                  </div>
                                  <div class="c-option">
                                    <input type="checkbox" name="Reason for Claim[]" value="Item has an open recallI I’ve been notified of" id="c-4" class="data-input-element">
                                    <label for="c-4">Item has an open recallI I’ve been notified of</label>
                                  </div>
                              </div>
                              <div class="pare pare-3">
                                  <div class="c-option">
                                    <input type="checkbox" name="Reason for Claim[]" value="Item appears to be inaccurate or uncalibrated" id="c-5" class="data-input-element">
                                    <label for="c-5">Item appears to be inaccurate or uncalibrated</label>
                                  </div>
                                  <div class="c-option">
                                    <input type="checkbox" name="Reason for Claim[]" value="Item is unusable due to a specific defective part" id="c-6" class="data-input-element">
                                    <label for="c-6">Item is unusable due to a specific defective part</label>
                                  </div>
                              </div>
                              <div class="pare pare-4">
                                  <div class="c-option">
                                    <input type="checkbox" name="Reason for Claim[]" value="Item has been damaged from an accident" id="c-7" class="data-input-element">
                                    <label for="c-7">Item has been damaged from an accident</label>
                                  </div>
                                  <div class="c-option">
                                    <input type="checkbox" name="Reason for Claim[]" value="Item does not power on, or complete startup" id="c-8" class="data-input-element">
                        ...
                        <div class="msf-step-input-field checkbox-describe">
                            ...
                            <input type="text" name="Description" id="describe" required="required" class="data-input-element">
                        </div>
                       </div>
                    </div>

                    <div class="msf-step-input name-email" id="step_<?=$form_id?>_3">
                        <div class="msf-step-input-field">
                            <label for="name">Your Name *:</label>
                            <input type="text" name="Name" id="name" required="required" class="data-input-element">
                        </div>
